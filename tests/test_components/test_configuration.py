...
from src.fandb.components.configuration import (
    ConfigMixin,
...
class TestConfigMixin:
    ...
    def test_from_dict_basic(self):
        ...
        data = {
            ...
            'port': 9000,
            'debug': True,
            'database': {'host': 'remote', 'port': 3306}
        }
    ...
    def test_to_dot_path_dict_simple(self):
    ...
    def test_to_dot_path_dict_custom_separator(self):
    ...
    def test_from_dot_path_dict_simple(self):
    ...
    def test_from_dot_path_dict_custom_separator(self):
...
class TestHelperFunctions:
    ...
    def test_dot_path_dict_to_nested_dict_simple(self):
    ...
    def test_dot_path_dict_to_nested_dict_empty(self):
        """Test dot_path_dict_to_nested_dict with empty input."""
        result = dot_path_dict_to_nested_dict({})
        assert result == {}

    def test_dot_path_dict_to_nested_dict_deep_nesting(self):
        """Test dot_path_dict_to_nested_dict with deep nesting."""
        input_data = {
            'a.b.c.d.e': 'deep_value',
            'a.b.c.d.f': 'another_deep',
            'x.y': 'shallow'
        }
        result = dot_path_dict_to_nested_dict(input_data)

        expected = {
            'a': {'b': {'c': {'d': {'e': 'deep_value', 'f': 'another_deep'}}}},
            'x': {'y': 'shallow'}
        }
        assert result == expected

    def test_nested_dict_to_dot_path_dict_simple(self):
    ...
    def test_nested_dict_to_dot_path_dict_empty(self):
        """Test nested_dict_to_dot_path_dict with empty input."""
        result = nested_dict_to_dot_path_dict({})
        assert result == {}

    def test_nested_dict_to_dot_path_dict_custom_separator(self):
    ...
    def test_merge_nested_dicts_empty_first(self):
    ...
    def test_merge_nested_dicts_empty_second(self):
    ...
    def test_merge_nested_dicts_both_empty(self):
